...
var ConversationController = {
  getConversationWith: (function () {
            ...
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  ...
                  _context.next = 5
                  return _conversation.ConversationService.getAllConversation(uid)
                case 5:
                  conversations = _context.sent
                  return _context.abrupt(
                    'return',
                    res.status(200).json((0, _toConsumableArray2['default'])(conversations))
                  )
                case 7:
                  _context.next = 9
                  return _conversation.ConversationService.getConversationWith(uid, chatWithUid)
                case 9:
    ...
    function getConversationWith(_x, _x2) {
        ...
        while (1) {
          switch ((_context5.prev = _context5.next)) {
            ...
            case 8:
              ...
              ReUserInfo = conver.map(
                /*#__PURE__*/ (function () {
                  var _ref4 = (0, _asyncToGenerator2['default'])(
                    /*#__PURE__*/ _regenerator['default'].mark(function _callee4(item) {
                      var userInfo
              ...
              ReUserInfo = conver.map(
                /*#__PURE__*/ (function () {
                  var _ref6 = (0, _asyncToGenerator2['default'])(
                    /*#__PURE__*/ _regenerator['default'].mark(function _callee6(item) {
                      var userInfo
